...
public class ProductSDK extends BaseSDK {
	...
	public boolean submitOrder(SEOROrder order) {
		...
		Item item = new Item().withPrimaryKey("order_id", order.getOrder_id())
				...
				.withDouble("totalcost_with_shipping", order.getTotalcost_with_shipping())
				...
				//.withString("payment_option", order.getPayment_option())
				//.withString("payment_option_amount", order.getPayment_option_amount())
